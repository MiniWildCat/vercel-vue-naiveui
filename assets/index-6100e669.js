import{_ as C,u as I,a as D,b as S,c as _,r as e,o as g,d as f,e as n,g as a,w as l,h as s,n as y,f as A}from"./index-6d22af44.js";const U={components:{},setup(){const r=I(),i=D(()=>(r.value,!1)),m=r;return{showAnchor:i,displayMode:S(),wrapperStyle:_(()=>m.value?"padding: 16px 16px 24px 16px;":"display: flex; flex-wrap: nowrap; padding: 32px 24px 56px 56px;"),contentStyle:_(()=>i.value?"width: calc(100% - 228px); margin-right: 36px;":"width: 100%; padding-right: 12px;"),url:"D:/Users/编程工作台/项目工作台/study-notes/4.学习工程化/0.学习turborepo/0.naive-ui-main/demo/pages/docs/import-on-demand/enUS/index.md"}}},P=n("pre",null,[n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"script"),s(">")]),n("span",{class:"language-javascript"},[s(`
...
`)]),n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"style"),s(">")])],-1),T=n("pre",null,[n("span",{class:"hljs-comment"},"// vite.config.ts"),s(`
...
})`)],-1),B=n("pre",null,[n("span",{class:"hljs-keyword"},"import"),s(" { createApp } "),n("span",{class:"hljs-keyword"},"from"),s(),n("span",{class:"hljs-string"},"'vue'"),s(`
...
app.`),n("span",{class:"hljs-title function_"},"use"),s("(naive)")],-1),z=n("pre",null,[n("span",{class:"hljs-tag"},[s("<"),n("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),n("span",{class:"hljs-tag"},[s("</"),n("span",{class:"hljs-name"},"template"),s(">")])],-1),M={key:0,style:{width:"192px"}};function R(r,i,m,d,G,V){const k=e("edit-on-github-header"),t=e("n-p"),v=e("n-a"),w=e("router-link"),h=e("n-h2"),o=e("n-code"),c=e("n-scrollbar"),p=e("n-card"),j=e("n-text"),u=e("n-anchor-link"),x=e("n-anchor");return g(),f("div",{class:"doc",style:y(d.wrapperStyle)},[n("div",{style:y(d.contentStyle)},[a(k,{"relative-url":"D:/Users/编程工作台/项目工作台/study-notes/4.学习工程化/0.学习turborepo/0.naive-ui-main/demo/pages/docs/import-on-demand/enUS/index.md",text:"Import on Demand (Tree Shaking)"}),a(t,null,{default:l(()=>[s("Naive UI supports tree shaking for components, locales and themes.")]),_:1}),a(t,null,{default:l(()=>[s("By default the component theme is light, locale is enUS, and no extra imports are needed.")]),_:1}),a(t,null,{default:l(()=>[s("For more info about theming, see "),a(w,{to:"customize-theme",custom:""},{default:l(({navigate:b,href:N})=>[a(v,{href:N,onClick:b},{default:l(()=>[s("Customizing Theme")]),_:2},1032,["href","onClick"])]),_:1}),s(".")]),_:1}),a(h,{id:"Import-Directly"},{default:l(()=>[s("Import Directly")]),_:1}),a(p,{embedded:"",bordered:!1,class:"md-card","content-style":"padding: 0;"},{default:l(()=>[a(c,{"x-scrollable":"","content-style":"padding: 16px;"},{default:l(()=>[a(o,null,{default:l(()=>[P]),_:1})]),_:1})]),_:1}),a(h,{id:"Auto-Import"},{default:l(()=>[s("Auto Import")]),_:1}),a(t,null,{default:l(()=>[s("you can use the "),a(j,{code:""},{default:l(()=>[s("unplugin-auto-import")]),_:1}),s(" plugin to automatically import API.")]),_:1}),a(t,null,{default:l(()=>[s("If you develop using SFC, you can use the "),a(j,{code:""},{default:l(()=>[s("unplugin-vue-components")]),_:1}),s(" plugin to automatically import components on demand.The plugin will automatically parse the components used in the template and import the components.")]),_:1}),a(p,{embedded:"",bordered:!1,class:"md-card","content-style":"padding: 0;"},{default:l(()=>[a(c,{"x-scrollable":"","content-style":"padding: 16px;"},{default:l(()=>[a(o,null,{default:l(()=>[T]),_:1})]),_:1})]),_:1}),a(h,{id:"Install-on-Demand-Globally"},{default:l(()=>[s("Install on Demand Globally")]),_:1}),a(p,{embedded:"",bordered:!1,class:"md-card","content-style":"padding: 0;"},{default:l(()=>[a(c,{"x-scrollable":"","content-style":"padding: 16px;"},{default:l(()=>[a(o,null,{default:l(()=>[B]),_:1})]),_:1})]),_:1}),a(t,null,{default:l(()=>[s("After the installation, you can use the components you installed in SFC like this.")]),_:1}),a(p,{embedded:"",bordered:!1,class:"md-card","content-style":"padding: 0;"},{default:l(()=>[a(c,{"x-scrollable":"","content-style":"padding: 16px;"},{default:l(()=>[a(o,null,{default:l(()=>[z]),_:1})]),_:1})]),_:1})],4),d.showAnchor?(g(),f("div",M,[a(x,{"internal-scrollable":"",bound:16,type:"block",style:{width:"192px",position:"sticky",top:"32px","max-height":"calc(100vh - 32px - 64px)",height:"auto"},"offset-target":"#doc-layout","ignore-gap":!0},{default:l(()=>[a(u,{title:"Import Directly",href:"#Import-Directly"}),a(u,{title:"Auto Import",href:"#Auto-Import"}),a(u,{title:"Install on Demand Globally",href:"#Install-on-Demand-Globally"})]),_:1})])):A("v-if",!0)],4)}const Z=C(U,[["render",R],["__file","D:/Users/编程工作台/项目工作台/study-notes/4.学习工程化/0.学习turborepo/0.naive-ui-main/demo/pages/docs/import-on-demand/enUS/index.md"]]);export{Z as default};
